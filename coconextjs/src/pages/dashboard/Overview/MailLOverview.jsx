...
import PieChartMailing from "@/components/PIeChartMailing";

export default function MailingOverview({ visible, setVisible, data }) {
  const {
    t,
    router,
    loading,
  ...
  useEffect(() => {
    ...
    if (openMailing) fetchData();
  }, [activity, activityType, openMailing]);
      ...
      <div className="card">
        ...
        >
          ...
          <button className="btn btn-link">
            <i
              className={`bx ${openMailing ? "bx-minus" : "bx-plus"}`}
              id="toggleIcon"
            ></i>
          </button>
        </div>
        <Collapse in={openMailing}>
          <div id="collapsibleDiv">
            <div className="card-body">
              ...
              <div className="col-lg-12 mb-4 d-flex gap-2">
                ...
                >
                  <PieChartMailing Sent={10} Pending={90} Failed={20} />
                </div>
